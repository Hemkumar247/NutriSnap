...
2. App sends image → Gemini Vision
3. AI returns:

   * Detected food items
   * Bounding boxes
   * Calorie + macro estimates
4. App displays visual overlays and structured data
5. User logs meal → Added to daily log

### **Text Mode Pipeline**

1. User types a description (ex: “2 rotis, paneer curry, 1 cup curd”)
2. Text is parsed → structured nutrition
3. Displayed and logged
