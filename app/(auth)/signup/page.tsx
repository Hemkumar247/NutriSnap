    ...
    if (successMessage) {
        return (
            <div className="flex flex-col items-center justify-center min-h-screen px-4">
                <div className="w-full max-w-md p-10 rounded-3xl text-center shadow-2xl backdrop-blur-[24px] border border-white/10" 
                    ...
                    <h2 className="text-2xl font-black mb-2" style={{ color: 'var(--text-strong)' }}>Account Created!</h2>
                    <p className="text-sm opacity-70 mb-8" style={{ color: 'var(--text-color)' }}>{successMessage}</p>
                    <button 
                        onClick={() => router.push('/login')}
                        className="w-full py-4 bg-white text-black rounded-2xl font-bold uppercase tracking-widest hover:bg-opacity-90 transition-all"
                    >
                        Go to Sign In
                    </button>
                </div>
            ...
            <div className="w-full max-w-md p-8 rounded-[2.5rem] animate-fade-in shadow-[0_32px_64px_-16px_rgba(0,0,0,0.3)] relative z-10 overflow-hidden" 
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-sm mt-2 opacity-70" style={{ color: 'var(--text-color)' }}>
                        Start tracking your health with AI precision
                    </p>
                </div>
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <input 
                            type="text"
                            placeholder={activeField === 'name' ? '' : "John Doe"}
                            value={name}
                    ...
                    <div>
                        ...
                        <input 
                            type="password"
                            placeholder={activeField === 'password' ? '' : "At least 6 characters"}
                            value={password}
                ...
                <p className="text-center mt-8 text-xs font-bold uppercase tracking-widest opacity-60" style={{ color: 'var(--text-color)' }}>
                    ...
                    <a href="/login" className="underline transition-colors decoration-2 hover:text-cyan-400" style={{ color: 'var(--brand-accent)' }}>
                        Sign in instead
                    </a>
                </p>
